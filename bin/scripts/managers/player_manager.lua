...
veteranRewards = {
		...
		{templateFile = "object/tangible/veteran_reward/antidecay.iff", milestone=120, oneTime=true, description="@veteran_new:antidecay"},
		...
		{templateFile = "object/tangible/wearables/armor/nightsister/armor_nightsister_bicep_r_s01.iff", milestone=330, oneTime=true, description="Nightsister Melee Armguard"},
